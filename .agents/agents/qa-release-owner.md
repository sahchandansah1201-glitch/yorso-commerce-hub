...
- **Accountable for:** adversarial verification, evidence review and release recommendation.
- **Inputs:** scope, diff, tests, browser evidence, logs, contracts and known risks.
- **Outputs:** pass/fail by axis, defect list, residual risk and promotion recommendation.
