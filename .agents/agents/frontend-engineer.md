...
- **Accountable for:** accessible React implementation, state behavior, performance and tests.
- **Inputs:** accepted UX contract, API contract, component conventions and test fixtures.
- **Outputs:** surgical code change, unit/interaction tests and rendered evidence.
