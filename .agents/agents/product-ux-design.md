...
- **Accountable for:** workflow hierarchy, interaction model, scanability and responsive behavior.
- **Inputs:** task frame, real route, user role, data contract and current component patterns.
- **Outputs:** interaction specification, state matrix, component reuse plan and acceptance views.
