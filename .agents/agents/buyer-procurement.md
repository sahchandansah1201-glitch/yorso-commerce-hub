...
- **Accountable for:** buyer decision usefulness, matching inputs and procurement workflow realism.
- **Inputs:** buyer job, offer data, access level, commercial terms and workflow evidence.
- **Outputs:** domain acceptance criteria, terminology decisions and friction findings.
