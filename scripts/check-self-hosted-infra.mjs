...
requireText(".env.example", envExample, "YORSO_PASSWORD_RECOVERY_CLEANUP_WORKER_ENABLED=false");
requireText(".env.example", envExample, "YORSO_PASSWORD_RECOVERY_CLEANUP_WORKER_INTERVAL_MS=3600000");
requireText(".env.example", envExample, "YORSO_PASSWORD_RECOVERY_CLEANUP_WORKER_BATCH_SIZE=500");
requireText(".env.example", envExample, "YORSO_PASSWORD_RECOVERY_CLEANUP_DELIVERY_RETENTION_MS=604800000");
requireText(".env.example", envExample, "YORSO_PASSWORD_RECOVERY_CLEANUP_TOKEN_RETENTION_MS=86400000");
requireText(".env.example", envExample, "YORSO_PASSWORD_RECOVERY_CLEANUP_WORKER_ID=password-recovery-cleanup-worker");
