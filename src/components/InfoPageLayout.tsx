  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container max-w-3xl py-12 md:py-16">
        <Link to="/" data-testid="info-back-home">
          <Button variant="ghost" size="sm" className="mb-6 gap-1.5 text-muted-foreground">
            <ArrowLeft className="h-4 w-4" /> {t.info_backToHome}
          </Button>
        </Link>
        <h1 data-testid="page-title" className="font-heading text-3xl font-bold tracking-tight text-foreground">
          {title}
        </h1>
        {updated && (
          <p data-testid="info-updated" className="mt-2 text-sm text-muted-foreground">
