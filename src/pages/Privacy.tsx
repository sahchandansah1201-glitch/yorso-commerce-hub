...
const Privacy = () => {
  ...
  <InfoPageLayout title={t.info_privacyTitle} updated="January 2026">
    ...
    <h2 className="font-heading text-xl font-bold text-foreground mt-8">How We Use Your Data</h2>
    ...
    <h2 className="font-heading text-xl font-bold text-foreground mt-8">Data Storage & Security</h2>
    ...
    <h2 className="font-heading text-xl font-bold text-foreground mt-8">Your Rights</h2>
