...
const Press = () => {
  ...
  <InfoPageLayout title={t.info_pressTitle}>
    ...
    <h2 className="font-heading text-xl font-bold text-foreground mt-8">About YORSO</h2>
    ...
    <h2 className="font-heading text-xl font-bold text-foreground mt-8">Brand Assets</h2>
