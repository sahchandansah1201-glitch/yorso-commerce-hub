...
const COPY: Record<Language, AuditCopy> = {
  en: {
    ...
    blocked: "Blocked",
    disabledBody: "Set VITE_YORSO_API_URL to inspect the self-hosted audit trail. The page does not use hosted BaaS in production mode.",
  ...
  ru: {
    ...
    disabledBody: "Укажите VITE_YORSO_API_URL, чтобы открыть self-hosted audit trail. Страница не использует hosted BaaS в production-режиме.",
  ...
  es: {
    ...
    blocked: "Bloqueado",
    disabledBody: "Define VITE_YORSO_API_URL para inspeccionar el audit trail self-hosted. La página no usa hosted BaaS en producción.",
