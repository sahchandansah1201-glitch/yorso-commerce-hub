...
const GDPR = () => {
  ...
  <InfoPageLayout title={t.info_gdprTitle} updated="January 2026">
    ...
    <h2 className="font-heading text-xl font-bold text-foreground mt-8">Your Rights Under GDPR</h2>
    <ul className="list-disc pl-5 space-y-1">
    ...
    <h2 className="font-heading text-xl font-bold text-foreground mt-8">Data Protection Officer</h2>
    <p>Contact: <a href="mailto:dpo@yorso.com" className="text-primary hover:underline">dpo@yorso.com</a></p>
    <h2 className="font-heading text-xl font-bold text-foreground mt-8">Supervisory Authority</h2>
