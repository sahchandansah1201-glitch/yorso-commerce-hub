...
const About = () => {
  ...
  <InfoPageLayout title={t.info_aboutTitle}>
    ...
    <h2 className="font-heading text-xl font-bold text-foreground mt-8">What We Do</h2>
    ...
    <h2 className="font-heading text-xl font-bold text-foreground mt-8">Key Facts</h2>
