...
const mobileChipTargetClass =
  "min-h-11 px-4 py-2 text-sm sm:min-h-0 sm:px-3 sm:py-1.5 sm:text-xs";
const mobileSmallChipTargetClass =
  "min-h-11 px-3.5 py-2 text-xs sm:min-h-0 sm:px-2.5 sm:py-1 sm:text-[11px]";
const mobileInlineActionClass =
          ...
          <div className="container py-3">
            ...
            >
              <Link
                ...
                data-blog-mobile-target="breadcrumb-home"
              >
            ...
            <div className="container py-10 md:py-14">
              ...
              >
                ...
                <div className="flex flex-col gap-4 p-6 md:p-8">
                  ...
                  <div>
                    <Button asChild className="h-11" data-blog-mobile-target="featured-read-article">
                ...
                {FILTER_KEYS.map((key) => {
                  ...
                  return (
                    <button
                      ...
                      aria-pressed={active}
                      data-blog-mobile-target="filter-chip"
                      className={cn(
                        "rounded-full border font-medium transition",
                        mobileChipTargetClass,
                        active
                          ...
                          >
                            ...
                            <div className="flex flex-1 flex-col gap-3 p-5">
                              ...
                              <div className="pt-1">
                                <Link
                                  to={`/blog/${p.slug}`}
                                  data-blog-mobile-target="read-article"
                                  className={cn(mobileInlineActionClass, "gap-1 text-sm font-semibold text-primary hover:underline")}
                                >
                                  {t.blog_readMore}
                  ...
                  <div className="mt-3 flex flex-wrap gap-1.5">
                    {TOPICS.map((topic) => (
                      <button
                        ...
                        data-blog-mobile-target="topic-chip"
                        className={cn(
                          "rounded-full border border-border bg-background font-medium text-foreground/80 transition hover:border-primary hover:text-primary",
                          mobileSmallChipTargetClass,
                        )}
                      >
                        {topic}
                      </button>
            ...
            <div className="container py-10 md:py-14">
              <div className="flex flex-wrap items-end justify-between gap-3">
                ...
                <button
                  ...
                  data-blog-mobile-target="see-all-updates"
                  className={cn(mobileInlineActionClass, "gap-1 text-sm font-semibold text-primary hover:underline")}
                >
