...
const en: TranslationKeys = {
  ...
  reg_buyerAutoRedirect: "You're signed in as a buyer. Opening the catalog in {seconds} s…",
...
const ru: TranslationKeys = {
  ...
  reg_buyerAutoRedirect: "Вы вошли как покупатель. Откроем каталог через {seconds} с…",
...
const es: TranslationKeys = {
  ...
  reg_buyerAutoRedirect: "Has iniciado sesión como comprador. Abrimos el catálogo en {seconds} s…",
