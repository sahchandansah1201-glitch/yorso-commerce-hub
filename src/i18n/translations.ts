...
const en: TranslationKeys = {
  ...
  hero_registerFree: "Create account",
  ...
  notFound_suggestion_register_title: "Create an account",
  ...
  catalog_value_ctaSignup: "Create account",
  ...
  catalog_row_priceCta_anon: "Create account",
  catalog_row_priceCta_reg: "Request price access",
  catalog_row_priceCta_reg_sent: "Request sent",
  catalog_row_priceAccess_anon: "Exact price available after creating an account",
  ...
  supplier_locked_anonCtaButton: "Access after registration",
  ...
  suppliersPage_errorBody: "Live supplier data did not load. Retry the self-hosted API before using this directory.",
  suppliersPage_retry: "Retry",
  suppliersPage_sourceApi: "Live directory",
  suppliersPage_sourceLocal: "Prototype directory",
  suppliersPage_sourceFallback: "Live directory error",
  ...
  account_branch_form_section_identity: "Identity",
  ...
  account_product_search_placeholder: "Product, Latin name, state or role...",
  ...
  account_product_duplicate_error: "This product already exists. Change the product, state or role.",
  ...
  account_product_form_desc: "Select the product, state and role. Add volume only when it is stable.",
  ...
  account_metaRegions_explainer: "Group countries for matching and notifications.",
...
const ru: TranslationKeys = {
  ...
  hero_registerFree: "Создать аккаунт",
  ...
  notFound_suggestion_register_title: "Создать аккаунт",
  ...
  catalog_value_ctaSignup: "Создать аккаунт",
  ...
  catalog_row_priceCta_anon: "Создать аккаунт",
  ...
  supplier_locked_anonCtaButton: "Доступ после регистрации",
  ...
  suppliersPage_errorBody: "Живые данные поставщиков не загрузились. Повторите запрос к self-hosted API перед использованием каталога.",
  suppliersPage_retry: "Повторить",
  suppliersPage_sourceApi: "Живой каталог",
  suppliersPage_sourceLocal: "Каталог прототипа",
  suppliersPage_sourceFallback: "Ошибка живого каталога",
  ...
  account_branch_form_section_identity: "Идентификация",
  ...
  account_product_search_placeholder: "Продукт, латинское название, состояние или роль...",
  ...
  account_product_duplicate_error: "Такой продукт уже есть. Измените продукт, состояние или роль.",
  ...
  account_product_form_desc: "Выберите продукт, состояние и роль. Объём укажите только если он стабильный.",
  ...
  account_metaRegions_explainer: "Объедините страны для матчинга и уведомлений.",
...
const es: TranslationKeys = {
  ...
  hero_registerFree: "Crear cuenta",
  ...
  notFound_suggestion_register_title: "Crear cuenta",
  ...
  catalog_value_ctaSignup: "Crear cuenta",
  ...
  catalog_row_priceCta_anon: "Crear cuenta",
  catalog_row_priceCta_reg: "Solicitar acceso al precio",
  catalog_row_priceCta_reg_sent: "Solicitud enviada",
  catalog_row_priceAccess_anon: "Precio exacto disponible tras crear una cuenta",
  ...
  supplier_locked_anonCtaButton: "Acceso tras el registro",
  ...
  suppliersPage_errorBody: "No se cargaron los datos reales de proveedores. Reintenta la API self-hosted antes de usar este directorio.",
  suppliersPage_retry: "Reintentar",
  suppliersPage_sourceApi: "Directorio en vivo",
  suppliersPage_sourceLocal: "Directorio prototipo",
  suppliersPage_sourceFallback: "Error del directorio en vivo",
  ...
  account_branch_form_section_identity: "Identificación",
  ...
  account_product_search_placeholder: "Producto, nombre latino, estado o rol...",
  ...
  account_product_duplicate_error: "Este producto ya existe. Cambia el producto, el estado o el rol.",
  ...
  account_product_form_desc: "Elige producto, estado y rol. Añade volumen solo si es estable.",
