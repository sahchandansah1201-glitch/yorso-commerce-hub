...
const en: TranslationKeys = {
  ...
  reg_buyerAutoRedirect: "You're signed in as a buyer. Taking you to the catalog in a few seconds…",
...
const ru: TranslationKeys = {
  ...
  reg_buyerAutoRedirect: "Вы вошли как покупатель. Через несколько секунд откроем каталог…",
...
const es: TranslationKeys = {
  ...
  reg_buyerAutoRedirect: "Has iniciado sesión como comprador. Te llevamos al catálogo en unos segundos…",
