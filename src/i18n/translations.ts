...
const en: TranslationKeys = {
  ...
  supplier_locked_legalHidden: "Access after supplier approval",
...
const ru: TranslationKeys = {
  ...
  supplier_locked_legalHidden: "Доступ после одобрения поставщика",
...
const es: TranslationKeys = {
  ...
  supplier_locked_legalHidden: "Acceso tras aprobación del proveedor",
