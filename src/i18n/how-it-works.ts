...
const ru: HowItWorksDict = {
  ...
  hero_titleSuffix: ".",
  hero_subtitle:
    "Заключай сделки, которое выдержит вопросы финансов, качества и руководства.",
  ...
  bds_subtitle:
    "До заключения сделки, менеджеру по закупкам нужно защитить её внутри компании. Yorso построен вокруг трёх вопросов, от которых зависит, будет ли ответ «да».",
  ...
  bds_cards: [
    {
      ...
      yorso: "Одна карточка поставщика: ОГРН/регистрационные данные, лицензия, сертификации (MSC, ASC, BRC, IFS, ХАССП) и история работы на Yorso.",
