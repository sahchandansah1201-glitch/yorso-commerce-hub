...
| `@supabase/supabase-js` dependency | Used by remaining catalog/access/reference tests. | Cannot remove until remaining imports are gone. | Remove in final Supabase retirement batch. |
